...
import com.clark.brokenview.BrokenCallback;
import com.clark.brokenview.BrokenTouchListener;
import com.clark.brokenview.BrokenView;
import com.clark.brokenview.MyView;
import com.clark.utils.R;

public class BrokenViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_brokenview);
		...
		whiteListener = new BrokenTouchListener.Builder(mBrokenView).setPaint(
				whitePaint).build();
	...
	private void initView() {
		...
		TextView refresh = (TextView) findViewById(R.id.action_refresh);
		...
		button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(BrokenViewActivity.this, "Button onClick",
	...
	private void initDrawerLayout() {
		...
		DrawerLayout mDrawerLayout = (DrawerLayout) this
				.findViewById(R.id.drawer_layout);
		@SuppressWarnings("deprecation")
		ActionBarDrawerToggle mDrawerToggle = new ActionBarDrawerToggle(this,
				mDrawerLayout, R.drawable.refresh, R.string.app_name,
				R.string.app_name) {
			@Override
	...
	public void refreshDate() {
		...
		for (int i = 0; i < 20; i++) {
			int color = Color.argb(0xff, rand.nextInt(0x99),
					rand.nextInt(0x99), rand.nextInt(0x99));
			ListItem item = new ListItem(color, "list item " + i);
			items.add(item);
		}
		listView.setAdapter(new SampleAdapter(BrokenViewActivity.this,
	...
	public void setOnTouchListener() {
		 ...
		 * set like this: childView.setOnTouchListener(new
		 * View.OnTouchListener() {
		 * 
		 * @Override public boolean onTouch(View v, MotionEvent event) { return
		 * false; } }); childView.setClickable(false);
		 * 
		 * if you want only click the button can break the parentLayout, set
		 * like this: listener = new BrokenTouchListener.Builder(mBrokenView).
		 * setEnableArea(button). build(); and set the button don't intercept
		 * touch event at the same time
		 */
	...
	public void showCallback(View v, String s) {
		switch (v.getId()) {/*
							 * case R.id.demo_parent: Toast.make(parentLayout,
							 * "RelativeLayout---" + s,
							 * Snackbar.LENGTH_SHORT).show(); break; case
							 * R.id.demo_image: Snackbar.make(parentLayout,
							 * "ImageView---" + s,
							 * Snackbar.LENGTH_SHORT).show(); break; case
							 * R.id.demo_list: Snackbar.make(parentLayout,
							 * "ListView---" + s, Snackbar.LENGTH_SHORT).show();
							 * break; case R.id.demo_myview:
							 * Snackbar.make(parentLayout, "CustomView---" + s,
							 * Snackbar.LENGTH_SHORT).show(); break; case
							 * R.id.demo_button: Snackbar.make(parentLayout,
							 * "Button---" + s, Snackbar.LENGTH_SHORT) .show();
							 * break;
							 */
		}
	}
